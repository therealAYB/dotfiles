...
plugins=(git gitfast last-working-dir common-aliases vscode sublime zsh-syntax-highlighting history-substring-search ssh-agent)
...
export DISPLAY=192.168.158.1:0
export BUNDLER_EDITOR="subl $@ >/dev/null 2>&1 -a"
export BUNDLER_EDITOR="subl $@ >/dev/null 2>&1 -a"
export BUNDLER_EDITOR="subl $@ >/dev/null 2>&1 -a"
